# _v1_workflows_post_request_tasks_inner
## Properties
...
| **task\_env** | **Map** | Environment variables (and values) to set in the task instance. | [optional] [default to null] |
...
| **init\_env** | **Map** | Environment variables (and values) to set in the init container. | [optional] [default to null] |
